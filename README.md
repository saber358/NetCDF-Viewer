...
基于 JavaFX 的 NetCDF 桌面可视化工具。面向海洋、水文、环境和数值模拟数据分析场景，支持非结构化三角网与规则格网 `.nc` 数据读取、二维平面渲染、单点查询、多数据集管理、在线底图、海岸线叠加、波浪叠加、海流流线叠加、风场风羽叠加与 PNG 导出。
...
- 在线底图走独立瓦片渲染链，支持 OSM、天地图和自定义 XYZ URL 模板
